      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="../logout.php"><i class="fa fa-dashboard"></i> Home</a></li>
          </ol>
        </section>
        <!-- Main content -->
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              <div class="small-box bg-green">
                ...
                <a href="quanlysanpham.php" class="small-box-footer">xem danh sách <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-nau">
                <div class="inner">
                <h3>Danh Sách</h3>
                  <p>Danh mục</p>
                </div>
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="danhsachsp.php" class="small-box-footer">Xem danh sách <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
